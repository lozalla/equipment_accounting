-- таблицы для генерации тестовых данных
...
(
	...
	property_type_id TINYINT UNSIGNED DEFAULT 0 NOT NULL comment 'тип недвижимости',
...
(
	...
	access_type_id TINYINT UNSIGNED NOT NULL comment 'тип доступа',
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
...
(
	...
	service_type_id TINYINT UNSIGNED NOT NULL DEFAULT 1 comment 'id тип обслуживания адреса',
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
...
DROP TABLE IF EXISTS equipment_technical_statuses;
CREATE TABLE equipment_technical_statuses
(
	id TINYINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	name varchar(200) UNIQUE NOT NULL,
	created_at datetime DEFAULT current_timestamp,
...
(
	...
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
			...
			один оператор может обслуживать несколько регионов,
