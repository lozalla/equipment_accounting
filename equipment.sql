...
(
	house_id SERIAL PRIMARY KEY comment 'id дома (таблицы домов, улиц, городв пока не проектируютс€)',
...
(
	...
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица статусов дл€ продажи услуг на оборудовании'
;
...
(
	...
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица статусов технического состо€ни€ оборудовани€'
;
...
(
	...
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица статусов технического состо€ни€ портов'
;
...
(
	...
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица типов оборудовани€'
;
...
(
	...
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица типов обслуживани€ адреса'
;
...
(
	...
	name varchar(200) NOT NULL ,
	equipment_type_id TINYINT UNSIGNED NOT NULL comment 'тип оборудовани€',
	number_ports TINYINT UNSIGNED NOT NULL DEFAULT 2 comment 'количество портов',
	sale_status_id TINYINT UNSIGNED NOT NULL DEFAULT 1 comment 'статус оборудовани€ дл€ продажи',
	technical_status_id TINYINT UNSIGNED NOT NULL DEFAULT 1 comment 'технический статус оборудовани€',
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
...
(
	...
	service_type_id TINYINT UNSIGNED NOT NULL comment 'id тип обслуживани€ адреса',
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица св€зей устройства-адреса, 
...
(
	...
	technical_status_id TINYINT UNSIGNED NOT NULL comment 'id технического состо€ни€ порта',
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
...
(
	...
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица операторов, которые ведут учет оборудовани€ в Ѕƒ'
;
...
(
	...
	created_at datetime DEFAULT current_timestamp,
	updated_at datetime DEFAULT current_timestamp ON UPDATE current_timestamp
) comment 'таблица св€зей операторов и регионов, которые они обслуживают
...
INSERT INTO  service_types (name) VALUES 
	('јдрес установки оборудовани€'),
	('ƒополнительный адрес обслуживани€')
	;
